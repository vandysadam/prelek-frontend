...
import { useDeleteCompanyMutation } from '../../../modules/company/company/api/company.api';
import { useFindAllEmployeeQuery } from '../../../modules/employee/api/employee.api';
...
function AdminEmployeeList() {
  ...
  const { data, refetch: refetchList } = useFindAllEmployeeQuery(
  ...
  const companyColumns = React.useMemo<Column<Employee>[]>(
    () => [
      ...
      },
      {
        Header: 'Company',
        accessor: (employee) =>
          employee.company_detail && employee.company_detail.companyName
            ? employee.company_detail.companyName
            : ''
      },
      {
        Header: 'Action',
