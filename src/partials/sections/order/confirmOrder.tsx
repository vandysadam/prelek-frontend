...
const ConfirmOrder: React.FC<Props> = (props: Props) => {
  const [confirm, { isLoading: confirming }] = useConfrimOrderMutation();
  const [reject, { isLoading: rejecting }] = useRejectOrderMutation();
  ...
  const validationSchema = React.useMemo(() => {
    if (props.purpose === "reject") {
      return Yup.object().shape({
        reasonOptions: Yup.string().required("Reject reason is required!"),
                  ...
                  <div className="space-y-4">
                      ...
                      <Field
                        ...
                        onChange={(event) => {
                          if (event.target.value !== "") {
                            setFieldValue("reasonOptions", event.target.value);
                    ...
                    <div>
                      ...
                      <Field
                        ...
                        className="form-input w-full"
                        disabled={values.reasonOptions !== "other"}
                      />
                      <div className="h-2">
                        <ErrorMessage
                          name="rejectReason"
            ...
            modalFooter={
              <div className="flex lg:justify-end pt-3">
                <div>
                  ...
                  <LoadingButton
                    loading={props.purpose ? confirming : rejecting}
                    loadingIndicator={
                    ...
                    disabled={props.purpose ? confirming : rejecting}
                  >
                    {props.purpose === "approve" ? (
                      <span>Confirm</span>
                    ) : (
