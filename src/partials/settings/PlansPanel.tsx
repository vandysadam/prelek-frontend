             ...
             {/* Tab 1 */}
              <div className="relative col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200">
                 ...
                 {/* CTA */}
                  <button className="btn border-gray-200 hover:border-gray-300 text-gray-600 w-full">Downgrade</button>
                </div>
             ...
             {/* Tab 2 */}
              <div className="relative col-span-full xl:col-span-4 bg-white shadow-md rounded-sm border border-gray-200">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200">
                 ...
                 {/* CTA */}
                  <button className="btn border-gray-200 bg-gray-100 text-gray-400 w-full cursor-not-allowed flex items-center" disabled>
