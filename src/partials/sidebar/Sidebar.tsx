...
import UserAndCompanyManagementSideBar from './sidebar-groups/UserAndCompanyManagement';
    ...
    <div>
      ...
      <div
        ...
        <div className="space-y-4">
          ...
          <UserAndCompanyManagementSideBar
            userRole={currentUser.roles as UserRoleEnum}
            pathname={pathname}
          />
        </div>
