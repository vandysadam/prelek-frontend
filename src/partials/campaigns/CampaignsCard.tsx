...
function CampaignsCard(props) {
  ...
  const categoryIcon = (category) => {
    switch (category) {
      ...
      case '3':
        return (
          <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-light-blue-500">
    ...
    <div className="col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="flex flex-col h-full p-5">
        ...
        <div className="grow mt-2">
          <Link className="inline-flex text-gray-800 hover:text-gray-900 mb-1" to={props.link}>
