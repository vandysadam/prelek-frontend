          ...
          <div className="grow flex flex-col p-5">
            ...
            <div className="grow">
              ...
              <header className="mb-3">
                <h3 className="text-lg text-gray-800 font-semibold">HTML, CSS, JavaScript - Build 6 Creative Projects</h3>
              </header>
              {/* Rating and price */}
          ...
          <div className="grow flex flex-col p-5">
            ...
            <div className="grow">
              ...
              <div className="flex flex-wrap justify-between items-center mb-4">
                ...
                {/* Price */}
                <div>
                  <div className="inline-flex text-sm font-medium bg-green-100 text-green-600 rounded-full text-center px-2 py-0.5">$49.00</div>
                </div>
              </div>
              {/* Features list */}
              <ul className="text-sm space-y-2 mb-5">
          ...
          <div className="grow flex flex-col p-5">
            ...
            <div className="grow">
              ...
              <div className="flex flex-wrap justify-between items-center mb-4">
                ...
                {/* Price */}
                <div>
                  <div className="inline-flex text-sm font-medium bg-green-100 text-green-600 rounded-full text-center px-2 py-0.5">$129.00</div>
                </div>
              </div>
              {/* Features list */}
              <ul className="text-sm space-y-2 mb-5">
