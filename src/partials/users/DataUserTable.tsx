...
import Users from "./DataUserTableItem";
...
function DataUserTableItem({ selectedItems,data,totalData }) {
  const users = [
    {
      id: "0",
      image: Photo01,
    ...
    <div className="bg-white shadow-lg rounded-sm border border-gray-200 relative">
      <header className="px-5 py-4">
        <h2 className="font-semibold text-gray-800">
          All users <span className="text-gray-400 font-medium">{totalData}</span>
        </h2>
      </header>
      <div>
        {/* Table */}
...
export default DataUserTableItem;
