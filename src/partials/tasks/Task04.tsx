...
function Task04() {
  return (
    <div className="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="font-semibold text-gray-800 mb-1">Managing teams (book)</h2>
      </div>
      {/* Meta */}
      ...
      <ul className="mt-3">
        <li className="flex items-center border-t border-gray-200 py-2">
          ...
          <div className="text-sm text-gray-400 line-through">Implement new designs</div>
        </li>
        <li className="flex items-center border-t border-gray-200 py-2">
          <svg className="w-3 h-3 shrink-0 fill-current text-gray-400 mr-2" viewBox="0 0 12 12">
            <path d="M10.28 1.28L3.989 7.575 1.695 5.28A1 1 0 00.28 6.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 1.28z" />
          </svg>
