...
function Task02() {
  return (
    <div className="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
      ...
      <div className="mb-3">
        {/* Title */}
        <h2 className="font-semibold text-gray-800 mb-1">User should receive a daily digest email</h2>
        {/* Content */}
        <div>
      ...
      <div className="flex items-center justify-between">
        {/* Left side */}
        <button className="p-2 shrink-0 rounded-full bg-white border border-gray-200 hover:border-gray-300 text-indigo-500 transition duration-150">
